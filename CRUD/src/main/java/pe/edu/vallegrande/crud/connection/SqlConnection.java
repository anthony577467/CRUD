package pe.edu.vallegrande.crud.connection;
...
public class SqlConnection {
    ...
    private static final String URL = "jdbc:sqlserver://localhost:1433;databaseName=CRUDUSER;encrypt=false;trustServerCertificate=true;";
