...
@WebServlet({"/CliGetAll", "/CliGetId", "/CliCrear", "/CliActualizar", "/CliBorrar", "/CliEditar"})
public class ClienteController extends HttpServlet {
    ...
    private void cliCreate(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (nombres != null && !nombres.isEmpty() && apellidos != null && !apellidos.isEmpty() && dniocarnet != null && !dniocarnet.isEmpty() && telefono != null && !telefono.isEmpty() && correo != null && !correo.isEmpty() && direccion != null && !direccion.isEmpty()) {
    ...
    private void cliDelete(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        int id = Integer.parseInt(req.getParameter("id"));
        ClienteService service = new ClienteService();
